...
- (void)dealloc
{
    ...
    [self.playerItem removeObserver:self forKeyPath:kKeyPathStatus];
}
...
-(void)initPlayer
{
    ...
    [self.playerItem addObserver:self forKeyPath:kKeyPathStatus options:0 context:NULL];
